...
export default function WeddingEstimator() {
  ...
  const renderStep = () => {
    ...
    if (k === "referral") return <SReferral v={data.referral} set={v => up("referral", v)} />;
  ...
  if (done) return (
    <div style={{ minHeight: "100vh", background: T.ivory, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      <div style={{ textAlign: "center", maxWidth: 480, animation: "fadeUp .8s ease" }}>
        ...
        <div style={{ marginTop: 32, paddingTop: 32, borderTop: `1px solid ${T.borderLight}` }}>
          <p style={{ fontFamily: T.sans, fontSize: 14, color: T.textSecondary, margin: "0 0 12px" }}>Vuoi una risposta più rapida?</p>
          <a href="https://wa.me/393273855362?text=Ciao%20Gaia%2C%20ho%20appena%20inviato%20una%20richiesta%20di%20preventivo%20dal%20sito%20%F0%9F%92%90" target="_blank" rel="noopener noreferrer" style={{ fontFamily: T.sans, fontSize: 13, letterSpacing: "1px", textTransform: "uppercase", fontWeight: 500, padding: "14px 32px", background: "#25D366", color: "#fff", borderRadius: 8, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8, transition: "all .3s" }}>
